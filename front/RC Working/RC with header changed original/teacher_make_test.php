 ...
 ?>
        ...
        <script>
            ...
            function filter_post()
            {
                ...
                xhttp.open("POST","https://web.njit.edu/~sk2292/RC/filter.php");
...
//                document.getElementById("test_questions_content").innerHTML = QID;
                ...
                //KRYSTAL'S POST.PHP URL IN THE NEXT LINE 
                xhttp.open("POST","https://web.njit.edu/~sk2292/RC/select_questions.php");
                xhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
                xhttp.send("QID="+QID);
            ...
            function makeTest()
            {
                ...
                //KRYSTAL'S POST.PHP URL IN THE NEXT LINE 
                xhttp.open("POST","https://web.njit.edu/~sk2292/RC/add_test_questions.php");
                xhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
